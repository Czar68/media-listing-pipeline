...
import { runBatch } from '../adapters/media-pipeline/runBatch';
import type { RawScanResult } from '../adapters/media-pipeline/types';
      ...
      if (draft.draft_status === 'READY_TO_PUBLISH') {
        ...
        rawItems.push({
          ...
          metadata: {
            ...
            listingStrategy: {
              pricing: {
                basePrice: draft.financials?.listing_price
              }
            }
          }
        });
